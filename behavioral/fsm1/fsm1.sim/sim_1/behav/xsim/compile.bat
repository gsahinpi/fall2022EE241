...
REM
REM Generated by Vivado on Fri Dec 16 13:53:04 +0300 2022
...
echo "xvlog --incr --relax -prj fsmtest_vlog.prj"
call xvlog  --incr --relax -prj fsmtest_vlog.prj -log xvlog.log
