...
REM
REM Generated by Vivado on Fri Dec 02 13:50:16 +0300 2022
...
echo "xvlog --incr --relax -prj sequentialtest_vlog.prj"
call xvlog  --incr --relax -prj sequentialtest_vlog.prj -log xvlog.log
