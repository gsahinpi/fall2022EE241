...
REM
REM Generated by Vivado on Tue Dec 06 14:44:32 +0300 2022
...
echo "xvlog --incr --relax -prj blocktb_vlog.prj"
call xvlog  --incr --relax -prj blocktb_vlog.prj -log xvlog.log
