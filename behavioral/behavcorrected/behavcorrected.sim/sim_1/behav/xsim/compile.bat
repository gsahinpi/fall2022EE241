...
REM
REM Generated by Vivado on Tue Dec 13 14:37:02 +0300 2022
...
echo "xvlog --incr --relax -prj testnonblocking_vlog.prj"
call xvlog  --incr --relax -prj testnonblocking_vlog.prj -log xvlog.log
