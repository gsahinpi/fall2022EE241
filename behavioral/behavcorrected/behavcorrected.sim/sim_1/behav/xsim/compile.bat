...
REM
REM Generated by Vivado on Thu Dec 08 23:55:58 +0300 2022
...
echo "xvlog --incr --relax -prj testswap_vlog.prj"
call xvlog  --incr --relax -prj testswap_vlog.prj -log xvlog.log
