...
REM
REM Generated by Vivado on Wed Jan 18 01:12:58 +0300 2023
...
echo "xvlog --incr --relax -prj testmultiplier_vlog.prj"
call xvlog  --incr --relax -prj testmultiplier_vlog.prj -log xvlog.log
