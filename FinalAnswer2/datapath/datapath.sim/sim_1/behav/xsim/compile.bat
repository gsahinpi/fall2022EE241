...
REM
REM Generated by Vivado on Tue Jan 17 23:39:54 +0300 2023
...
echo "xvlog --incr --relax -prj dptest_vlog.prj"
call xvlog  --incr --relax -prj dptest_vlog.prj -log xvlog.log
